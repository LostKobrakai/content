...
- [Web APIs](/en-US/docs/Web/API)
  - : Reference material for the set of JavaScript programming APIs you can use to build apps on the Web — including the core DOM APIs and all related APIs.
...
- [HTTP](/en-US/docs/Web/HTTP)
  - : HTTP is the fundamental Internet protocol for fetching documents, stylesheets, scripts, images, videos, fonts, and other resources over the Web.
